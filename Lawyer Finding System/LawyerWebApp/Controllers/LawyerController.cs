...
namespace LawyerWebApp.Controllers
{
    public class LawyerController : Controller
    {
       ...
       public  ActionResult ProfileForOthers(int userID)
       {
           Lawyer user = lawyerRepository.GetLawyerByID(userID);
           return View(user);
       }
        public ActionResult ProfileForOthersLoggedInRejected(int userID)
        {
            Lawyer user = lawyerRepository.GetLawyerByID(userID);
            return View(user);
        }
        public ActionResult ProfileForOthersLoggedInAccepted(int userID)
        {
            Lawyer user = lawyerRepository.GetLawyerByID(userID);
            return View(user);
        }
